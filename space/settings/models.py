...
class Settings(BaseSettings):
    ...
    github_user: str      = Field(validation_alias="GITHUB_USER", default="nairaxo")
    github_repo: str      = Field(validation_alias="GITHUB_REPO", default="nairaxo/bambara-asr-leaderboard")
    github_email: str     = Field(validation_alias="GITHUB_EMAIL", default="naira.abdoumohamed@gmail.com")
